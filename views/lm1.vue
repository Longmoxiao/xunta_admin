...
export default{
    ...
    data() {
        return {
            ...
            { id: '2', temperamentName: '甜美型', phone: '技能', gender: '女', age: '23', }
            ],
            tableLabel: [{ prop: 'id', label: '序号', width: "270" },
            { prop: 'temperamentName', label: '气质类型名称', width: "570" },
    ...
    methods: {
        init() {
            const _this = this;
            axios.post('/admin/temperamentTag/search_tag', { page: '1', pageSize: '7' })
